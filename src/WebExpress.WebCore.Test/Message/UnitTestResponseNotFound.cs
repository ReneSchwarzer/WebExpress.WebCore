...
{
    /// <summary>
    /// Unit tests for the ResponseNotFound class.
    /// </summary>
    public class UnitTestResponseNotFound
    {
        /// <summary>
        ...
        {
            // act
            var response = new ResponseNotFound();
        ...
        public void DefaultContent()
        {
            ...
            Assert.Contains("404 -", response.Content as string);
        }
    }
}
