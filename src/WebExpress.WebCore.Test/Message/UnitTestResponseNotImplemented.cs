...
{
    /// <summary>
    /// Unit tests for the ResponseNotImplemented class.
    /// </summary>
    public class UnitTestResponseNotImplemented
    {
        /// <summary>
        ...
        {
            // act
            var response = new ResponseNotImplemented();
        ...
        public void DefaultContent()
        {
            ...
            Assert.Contains("501 -", response.Content as string);
        }
    }
}
