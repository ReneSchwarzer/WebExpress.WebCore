...
namespace WebExpress.WebCore.Test
{
    ...
    [Event<TestEventB>]
    public sealed class TestEventHandlerB1 : IEventHandler<TestEventArgument>
    {
        /// <summary>
        ...
        private TestEventHandlerB1(IEventHandlerContext eventHandlerContext, IApplicationManager applicationManager)
        {
            // test the injection
