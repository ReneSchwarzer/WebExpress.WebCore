...
namespace WebExpress.WebCore.Test
{
    ...
    //[Application<TestApplicationB>()] test for empty application
    [StatusResponse<ResponseNotFound>()]
    [Icon("/webexpress/icon.png")]
    public sealed class TestStatusPageB500 : IStatusPage<RenderContext>
    {
        /// <summary>
        ...
        private TestStatusPageB500(IStatusPageContext statusPageContext)
        {
            // test the injection
