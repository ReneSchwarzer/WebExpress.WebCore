...
namespace WebExpress.WebCore.WebPage.Model
{
    ...
    internal class PageItem : IDisposable
    {
        ...
        /// <summary>
        /// Gets or sets the instance of the page, if the page is cached, otherwise null.
        /// </summary>
        public IEndpoint Instance { get; set; }

        /// <summary>
        /// Gets or sets the scope names that provides the resource. The scope name
        ...
        /// <summary>
        /// Gets or sets whether all subpaths should be taken into sitemap.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets whether it is a optional resource.
        /// </summary>
