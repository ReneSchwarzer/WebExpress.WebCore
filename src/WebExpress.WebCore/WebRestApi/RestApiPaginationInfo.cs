...
namespace WebExpress.WebCore.WebRestApi
{
    ...
    {
        /// <summary>
        /// Returns or sets the current page number in a paginated result set.
        /// </summary>
        [JsonPropertyName("page")]
        public int PageNumber { get; set; }

        /// <summary>
        /// Returns or sets the number of items to display per page in a paginated list.
        /// </summary>
        [JsonPropertyName("pageSize")]
        public int PageSize { get; set; }

        /// <summary>
        /// Returns or sets the total count of items.
        /// </summary>
